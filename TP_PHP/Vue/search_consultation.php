                    ...
                    <div class="main_body">
                        ...
                        <div class="Left-body">
                            <div class="Left-body-head">
                                Rechercher une consultation par la date 
                            </div>
                            <div class="infos">
                            </div>
                            <div class="en_bref">
                                <form action="search_consultation.php" method="post">
                                <input class="textfield_form" type="date" name="Date_Consultation" size="50"/><br/>
                            ...
                            <table class="table" style="width:20%">
                                    ...
                                    <tr>
                                        ...
                                        <th>Compte-rendu consultation</th>
                                        <th>Id patient</th>
                                        <th>Id médecin</th>
                                    </tr>
                                    </thead>
                                ...
                                if(isset($_POST["Date_Consultation"])){
                                    $Query = "SELECT * FROM consultation WHERE Id_Medecin='$Medecin_Id'AND Date_Consultation='".$_POST["Date_Consultation"]."'" ;
                                    //echo $Query;
                                    $Util->dbConnection();
