                    ...
                    <div class="main_body">
                        ...
                        <div class="Left-body">
                            ...
                            <table class="table" style="width:100%">
                                ...
                                <tbody>
                                <?php
                                    $Query = "SELECT Date_Rendez_Vous, Salle_Rendez_Vous, Id_Patient FROM rendez_vous WHERE Id_Medecin='1'" ;
                    ...
                    <div class="Right-body">
                        <div class="About-us">
                            ...
                            <div class="Social-NW-body">
                                ...
                                <a href="list_patient.php"><i class="icon-user"></i> Liste des patients</a>
                                <br/>
